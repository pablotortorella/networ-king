...
- Poder compartir los datos de contacto personales mediante un código QR.

- Login con Google.

- Unirse a evento por código.

- Compartir contactos entre miembros del evento que sean conocidos entre sí.

- Registrar nota breve.

- Actualizar estado post-evento.
...
Listas:
- Crear evento.
- Pedir fecha inicio y fecha fin para cada evento.
- Al crear un evento, no ofrecer más las opciones de creación de nuevo evento, pasar directamente a la creación de contactos de ese evento. Pero dejar la posibilidad de crear nuevo evento como una función un poco más oculta, por ejemplo en un menú tipo hamburguesa o similar, con menor protagonismo que la creación de contactos.

- Crear contacto desde celular con formulario rápido.
- Clasificar tipo y calificación de cada contacto.
- Marcar uno o varios siguientes pasos.
- Ver listado filtrable de contactos de cada evento.
